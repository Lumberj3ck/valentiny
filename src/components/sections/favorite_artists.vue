    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-wrap justify-center text-center mb-24">
        <div class="w-full lg:w-6/12 px-4">
          ...
          <custom_input :photoMode="photoMode" text_area :primary_color="primary_color" class='text-lg leading-relaxed m-4 text-gray-600'
      ...
      <div class="flex flex-wrap">
        <div v-for="(item, index) in items" :key="index" class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
          <div class="px-6">
            <image_input :photoMode="photoMode" image_tag :image_url="item.image" :reset_img="reset_img" @update:reset="reset_img = false"
            ...
            <div class="pt-6 text-center">
              <custom_input :photoMode="photoMode" :primary_color="primary_color" class="text-xl font-bold" :default_input_value="item.name">
              </custom_input>
            </div>
          </div>
        </div>
