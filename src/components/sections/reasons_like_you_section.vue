      ...
      <div class="flex flex-wrap items-center">
        <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
          <div
            ...
            <icon_picker :photoMode="photoMode" :section_name="section_name" :picker_id="1" :style="{'color': text_color}" defaultIcon="heart"></icon_picker>
          </div>
          ...
          <ol class="text-lg font-light leading-relaxed mt-4 mb-4 text-gray-700 flex flex-col gap-1" :style="primary_color">
            <custom_input :section_name="section_name" :input_id="2" :photoMode="photoMode" :primary_color="primary_color" class='font-light max-w-[80vw]'
              default_input_value="1 Name"></custom_input>
            <custom_input :section_name="section_name" :input_id="3" :photoMode="photoMode" :primary_color="primary_color" class='font-light max-w-[80vw]'
              default_input_value="2 Good cooking"></custom_input>
            <custom_input :section_name="section_name" :input_id="4" :photoMode="photoMode" :primary_color="primary_color" class='font-light max-w-[80vw]'
              default_input_value="3 Favorite girl"></custom_input>
            <custom_input :section_name="section_name" :input_id="5" :photoMode="photoMode" :primary_color="primary_color" class='font-light max-w-[80vw]'
              default_input_value="4 Cute sunn"></custom_input>
            <custom_input :section_name="section_name" :input_id="6" :photoMode="photoMode" :primary_color="primary_color" class='font-light max-w-[80vw]'
        ...
        <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
          <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-pink-600"
            ...
            <image_input :section_name="section_name" :image_input_id="1" :photoMode="photoMode" image_tag custom_class="w-full align-middle rounded-t-lg" :image_url="image_url"></image_input>
