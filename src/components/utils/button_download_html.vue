...
<template>
    ...
    <div class="flex py-2 md:py-0 text-2xl">
        <!-- <h1 class="text-color font-semibold text-lg mr-2">Download Page:</h1> -->
        <i @click="get_html" class="fa-solid fa-download cursor-pointer text-color button_icon"></i>
    </div>
</template>
